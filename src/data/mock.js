...
export const mockCustomers = [
  {
    ...
    email: "maya.chen@greenleaf.example",
  ...
  },
  {
    ...
    email: "dev.okafor@northwind.example",
  ...
  },
  {
    ...
    email: "priya.nair@atlasfreight.example",
  ...
  },
  {
    ...
    email: "tom.becker@sunriseretail.example",
  ...
  },
  {
    ...
    email: "lena.voss@quantahealth.example",
  ...
  },
  {
    ...
    email: "iris.wong@beaconstudios.example",
...
export const mockCustomerMemories = [
  {
    ...
    sourceName: "Jun 12 meeting",
    sourceMeta: "Saved context",
    createdAt: "2026-06-12T09:00:00.000Z",
  },
  {
    id: "mem-cust1-security",
    customerId: "cust1",
    kind: "note",
    title: "Security blocker",
    summary:
      "Maya asked for a concise security review and wants open data-retention questions answered before moving the Greenleaf deal to procurement.",
    sourceName: "Jun 14 advisor note",
    sourceMeta: "Action item",
  ...
  },
  {
    ...
    title: "ROI deck prep",
    summary:
      "Northwind wants the ROI deck to compare saved RevOps hours against rollout effort and include a short migration timeline.",
    sourceName: "Jun 10 meeting",
    sourceMeta: "Saved context",
  ...
  },
  {
    ...
    customerId: "cust3",
    kind: "note",
    title: "Technical demo scope",
    summary:
      "Atlas Freight needs the demo to show logistics exception handling and executive-level reporting for late shipments.",
    sourceName: "Jun 11 advisor note",
    sourceMeta: "Demo prep",
    createdAt: "2026-06-11T14:00:00.000Z",
  },
  {
    id: "mem-cust4-onboarding",
    customerId: "cust4",
    kind: "note",
    title: "Kickoff checklist",
    summary:
      "Sunrise Retail is ready for onboarding; first kickoff should confirm store rollout order, admin owners, and reporting cadence.",
    sourceName: "Jun 15 note",
    sourceMeta: "Closed won",
  ...
  },
  {
    ...
    customerId: "cust5",
    kind: "meeting",
    title: "Sponsor re-engagement",
    summary:
      "Quanta Health has gone quiet for 21 days. Re-engage the executive sponsor with a short risk recap and one concrete renewal checkpoint.",
    sourceName: "May 30 meeting",
    sourceMeta: "At-risk account",
  ...
  },
  {
    ...
    summary:
      "Beacon Studios is inbound but budget is still unqualified. Ask Iris for decision timing, target team size, and approval process.",
    sourceName: "Jun 08 note",
    sourceMeta: "Qualification",
